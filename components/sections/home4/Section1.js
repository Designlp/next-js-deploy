          ...
          <div className="container">
            <div className="banner-inner">
              <div className="box-banner-left">
                <Link className="btn btn-brand-6-new" href="#">
                  <span>New</span>AI analytics 3.0
                  <svg
                ...
                <h1 className="display-2 mb-30 mt-25">
                  Digital Agency with
                  <span className="text-96">Excellence Services</span>
                </h1>
              ...
              <div className="box-banner-right">
                <div className="box-images-banner-6">
                  <span className="animate-1">
                    <img
                      src="/assets/imgs/page/homepage4/banner-arrow.png"
                      alt="Nivia"
                    />
                  </span>
                  <span className="animate-2">
                    <img
