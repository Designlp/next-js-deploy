        ...
        <Swiper {...swiperOptions}>
          <SwiperSlide>
            <div className="card-news">
              ...
              <div className="card-info">
                <Link className="heading-4" href="/blog-post">
                  Now the pain is very important, and the teaching is
                  consistent.
                </Link>
                <p className="text-md neutral-700 mt-15 mb-35">
                  Pellentesque at posuere tellus. Ut sed dui justo. Phasellus is
                  scelerisque turpis arcu, ut pulvinar lectus tristique non. Nam
                  laoreet, risus vel laoreet laoreet, mauris
                </p>
          ...
          <SwiperSlide>
            <div className="card-news">
              ...
              <div className="card-info">
                <Link className="heading-4" href="/blog-post">
                  The behavior of the pain itself is important, consistent with
                </Link>
                <p className="text-md neutral-700 mt-15 mb-35">
                  Pellentesque at posuere tellus. Ut sed dui justo. Phasellus is
                  scelerisque turpis arcu, ut pulvinar lectus tristique non. Nam
          ...
          <SwiperSlide>
            <div className="card-news">
              ...
              <div className="card-info">
                <Link className="heading-4" href="/blog-post">
                  How startups can improve their chances of getting financing
                </Link>
                <p className="text-md neutral-700 mt-15 mb-35">
                  Pellentesque at posuere tellus. Ut sed dui justo. Phasellus is
                  scelerisque turpis arcu, ut pulvinar lectus tristique non. Nam
